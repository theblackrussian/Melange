...
2. You extract a summary of each file provided to you in 20 words or less, into a section called SUMMARY x, where x represents the number of the file.
...
4. You extract the top 5 quotes for each file in a section called QUOTES. Format the quotes (capitalize the first letter, add a period at the end)

5. You combine all understanding of all the files into a single, 50-word max paragraph in a section called SUMMARY ALL FILES.
